...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "The fully-qualified name for the output artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "The simple cleaned dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "The minimum price for renting",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "The maximum price for renting",
        required = True
    )
